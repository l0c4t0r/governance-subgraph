...
A live version of this subgraph can be found [here](https://thegraph.com/explorer/subgraph/protofire/Candle-governance), along with useful queries and examples already available on the playground.
